...
Write-Host "Waiting for Sparrow Compose services."
...
$requestId = "sparrow-smoke-$([Guid]::NewGuid().ToString('N'))"
...
Write-Host "Sparrow network smoke test passed for $($services.Count) Compose services."
