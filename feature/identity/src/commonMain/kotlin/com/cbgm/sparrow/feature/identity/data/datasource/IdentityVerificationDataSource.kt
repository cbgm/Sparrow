...
internal class IdentityVerificationDataSource(
    ...
    private val payloadEncoder: IdentityVerificationReceiptEncoder,
    ...
    suspend fun verify(contactId: String) {
        ...
        mutex.withLock {
            val identity = remoteIdentityDao.findByPeerId(contactId)
                ?: error("Contact has no Sparrow identity: $contactId")
            val updatedAt = SystemClock.nowEpochMilliseconds()
            val updatedRows =
                remoteIdentityDao.updateVerificationStatusIfKeysMatch(
                    contactId = contactId,
    ...
    suspend fun receiveReceipt(
        ...
        mutex.withLock {
            ...
            val identity = remoteIdentityDao.findByPeerId(context.contactId)
            ...
            val updatedRows =
                remoteIdentityDao.markVerifiedByContactIfKeysMatch(
