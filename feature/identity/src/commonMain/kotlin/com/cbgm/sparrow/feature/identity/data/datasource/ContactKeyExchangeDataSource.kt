...
class ContactKeyExchangeDataSource(
    ...
    suspend fun storeRemoteIdentity(
        ...
        val nextRemoteIdentityPacketReceived =
            sameIdentity && existing.remoteIdentityPacketReceived || origin == RemoteIdentityOrigin.REMOTE_PACKET || origin == RemoteIdentityOrigin.REMOTE_HANDSHAKE
    ...
    suspend fun acceptRemoteIdentityForHandshake(
        ...
        check(updatedRows == 1) {
            "Contact identity changed before handshake acceptance was recorded"
        }
    }
