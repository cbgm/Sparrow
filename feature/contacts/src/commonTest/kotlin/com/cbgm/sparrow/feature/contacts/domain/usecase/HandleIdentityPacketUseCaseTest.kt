...
class HandleIdentityPacketUseCaseTest {
    @Test
    fun identityPacketStoresRemoteKeysAndQueuesSignedAcknowledgement() =
        runTest {
            val keyExchangeStore = RecordingContactKeyExchangeRepository()
            ...
            val handler =
                HandleIdentityPacketUseCase(
                    ...
                    contactKeyExchangeRepository = keyExchangeStore,
                    ...
                    contactVerificationRepository = noOpContactVerificationRepository
                )
    ...
    fun identityStoreFailurePreventsSignatureAndAcknowledgement() =
        runTest {
            val keyExchangeStore =
                RecordingContactKeyExchangeRepository(
        ...
        runTest {
            ...
            val handler =
                HandleIdentityAcknowledgementPacketUseCase(
                    contactRepository = FakeContactRepository(createContact()),
                    contactKeyExchangeRepository = RecordingContactKeyExchangeRepository(),
    ...
    private val noOpContactVerificationRepository =
        object : ContactVerificationRepository {
            ...
            override suspend fun receiveReceipt(
                ...
                packet: com.cbgm.sparrow.core.protocol.packet.ContactVerificationReceiptPacket
    ...
    private class RecordingContactKeyExchangeRepository(
    ...
    private class RecordingProtocolOutbox : ProtocolOutbox {
        ...
        var enqueuedPacket: SparrowPacket? = null
