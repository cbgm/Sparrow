...
class ContactMergeServiceImpl(
    ...
    override suspend fun findOrCreateForSparrowIdentity(
        signingPublicKey: ByteArray,
        phoneNumber: String?
    ): ContactMergeResult {
