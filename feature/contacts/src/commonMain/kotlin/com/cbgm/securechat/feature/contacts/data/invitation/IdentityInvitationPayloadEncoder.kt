package com.cbgm.securechat.feature.contacts.data.invitation
...
class IdentityInvitationPayloadEncoder {
    fun encodeInvite(
        ...
        encode(
            domainSeparator = "SecureChat.ContactInvite",
    ...
    fun encodeAccepted(
        ...
        encode(
            domainSeparator = "SecureChat.ContactInviteAccepted",
            packetId.encodeToByteArray(),
            ByteArrays.encodeInt(version),
            invitationId.encodeToByteArray(),
    ...
    fun encodeReady(
        ...
        encode(
            domainSeparator = "SecureChat.ContactReady",
            packetId.encodeToByteArray(),
            ByteArrays.encodeInt(version),
            invitationId.encodeToByteArray(),
    ...
    fun encodeDeclined(
        ...
        encode(
            domainSeparator = "SecureChat.ContactInviteDeclined",
            packetId.encodeToByteArray(),
            ByteArrays.encodeInt(version),
            invitationId.encodeToByteArray(),
