...
object DisclaimerContent {
    val privacyPolicy =
        ...
        This Privacy Policy explains what information Sparrow collects,
        how it is used, and the choices available to you.

        ## Information we do not collect

        Sparrow is designed around end-to-end encryption. Message
        content is encrypted on your device and cannot be read by us,
        the Sparrow server infrastructure, or any third party in transit.
        ...
        Undelivered messages are retained by Sparrow server infrastructure only until
    ...
    val dataDisclaimer =
        ...
        This page explains, in plain terms, what Sparrow stores and
        where.
