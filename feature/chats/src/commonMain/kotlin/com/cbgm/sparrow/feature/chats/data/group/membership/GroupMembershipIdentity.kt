...
import com.cbgm.sparrow.feature.chats.data.group.invitation.InvitationIdentityPolicy
...
internal class GroupMembershipIdentity(
    ...
    suspend fun stageIncomingOwnerIdentity(
        ...
        val existing = requireContact(contactId).sparrowIdentity
    ...
    suspend fun requireAcceptedOwnerIdentity(invitation: GroupInvitationEntity) {
        val existingIdentity = requireContact(invitation.contactId).sparrowIdentity
        ...
        val acceptedIdentity =
            requireContact(invitation.contactId).sparrowIdentity
    ...
    suspend fun storeMutualIdentity(
        ...
        val existingIdentity = requireContact(contactId).sparrowIdentity
        val sameIdentity =
            existingIdentity != null &&
