...
class GroupVerificationPayloadEncoder {
    ...
    private companion object {
        val RECEIPT_DOMAIN = "securechat.group-verification-receipt.v1".encodeToByteArray()
        val SNAPSHOT_REQUEST_DOMAIN = "securechat.group-verification-snapshot-request.v1".encodeToByteArray()
        val SNAPSHOT_DOMAIN = "securechat.group-verification-snapshot.v1".encodeToByteArray()
